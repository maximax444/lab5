    ...
    public void interactiveMode() {
        ...
        try {
            do {
                ...
                commandManager.startExecuteCommand(userInput[0], userInput[1]);
    ...
    public void scriptMode(String arg) {
        ...
        try (Scanner scriptScanner = new Scanner(new File(arg))) {
            ...
            do {
                ...
                Console.println(userInput[0] + " " + userInput[1]);
                ...
                commandStatus = commandManager.startExecuteCommand(userInput[0], userInput[1]);
